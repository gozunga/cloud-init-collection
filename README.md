...
| [`ai/ubuntu-vllm-qwen-image-21.yaml`](./ai/ubuntu-vllm-qwen-image-21.yaml) | [vLLM-Omni](https://github.com/vllm-project/vllm-omni) serving **[Qwen-Image-2.1](https://huggingface.co/Qwen/Qwen-Image-2.1)** plus a prompt page | 48 GB (L40S) | `3000` (image page), `8000` (image API) |
